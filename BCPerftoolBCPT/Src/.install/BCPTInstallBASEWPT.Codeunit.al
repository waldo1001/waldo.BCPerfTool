codeunit 75000 "BCPT Install BASE WPT"
{
    ...
    begin
        if BCPTTestSuite.TestSuiteExists('BASE') then
            exit;
        ...
        BCPTTestSuite.AddLineToTestSuiteHeader('BASE', codeunit::"BCPT Open Chart of Acc. WPT", 3, 'Open Chart of Accounts', 500, 1000, 5, true, '');
        BCPTTestSuite.AddLineToTestSuiteHeader('BASE', codeunit::"BCPT Open Customer List WPT", 3, 'Open Customer List', 500, 1000, 5, true, '');
        BCPTTestSuite.AddLineToTestSuiteHeader('BASE', codeunit::"BCPT Open Item List WPT", 3, 'Open Item List', 500, 1000, 5, true, '');
        BCPTTestSuite.AddLineToTestSuiteHeader('BASE', codeunit::"BCPT Open Purch. Inv. List WPT", 3, 'Open Purch. Invoice List', 500, 1000, 5, true, '');
        BCPTTestSuite.AddLineToTestSuiteHeader('BASE', codeunit::"BCPT Open RoleCenter SOP WPT", 3, 'Open RoleCenter SOP', 500, 1000, 5, true, '');
        BCPTTestSuite.AddLineToTestSuiteHeader('BASE', codeunit::"BCPT Open Sls Inv List WPT", 3, 'Open Sales Invoice List', 500, 1000, 5, true, '');
        BCPTTestSuite.AddLineToTestSuiteHeader('BASE', codeunit::"BCPT Open Vendor List WPT", 3, 'Open Vendor List', 500, 1000, 5, true, '');
